...
export const AspectRatioBody = (_props) => {
    const _a = Object.assign(Object.assign({}, defaultProps), _props), { component: Component, className } = _a, rest = __rest(_a, ["component", "className"]);
