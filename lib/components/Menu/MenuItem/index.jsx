...
exports.MenuItem = react_1.forwardRef(function (props, ref) {
    ...
    var menuContext = react_1.useContext(MenuContext_1.default);
    var classOfComponent = classnames_1.default(styles_module_scss_1.default.menuItem, className, (_a = {},
    ...
    return <ListItem_1.default {...rest} ref={ref} className={classOfComponent} onClick={handleOnClick}/>;
});
