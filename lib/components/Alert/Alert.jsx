...
var Alert = react_1.default.forwardRef(function (props, ref) {
    var _a;
    var _b = __assign(__assign({}, defaultProps), props), type = _b.type, children = _b.children, rest = __rest(_b, ["type", "children"]);
    var classOfRoot = classnames_1.default(styles_module_scss_1.default['root'], (_a = {},
        _a[styles_module_scss_1.default["type-" + type]] = type,
        _a));
    return (<div className={classOfRoot} {...rest}>
      <Typography_1.default type={Typography_1.TypoTypes.invert}>{children}</Typography_1.default>
    </div>);
});
