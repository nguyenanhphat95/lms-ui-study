...
var MultiSelectInput = react_1.forwardRef(function (props, ref) {
    ...
    return (<react_1.Fragment>
        <div className={classnames_1.default(styles_module_scss_1.default.select, styles_module_scss_1.default["multiple-select-size-" + rest.size], className, (_a = {},
        ...
        _a))} ref={ref} onClick={onClick}>
          <Typography_1.default truncate={1} type={Typography_1.TypoTypes.sub} className={classnames_1.default(styles_module_scss_1.default['label-text'], styles_module_scss_1.default["label-size-" + rest.size])}>
