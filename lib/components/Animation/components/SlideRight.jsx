...
var SlideRight = function (_a) {
    ...
    return (<Component initial={{ opacity: 0, x: '-17.5%' }} animate={{ opacity: 1, x: -0 }} exit={{ opacity: 0, x: '-17.5%' }} transition={{
        duration: duration,
        type: 'spring',
        stiffness: 275,
        damping: 17.5,
...
//# sourceMappingURL=SlideRight.jsx.map